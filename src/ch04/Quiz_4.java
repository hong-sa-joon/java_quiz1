...
값을 (값1, 값2) 형태로 출력하고, 값의 합이 5가 아니면 계속 주사위를 던지고, 값의 합이 5이면 실행을 멈추는 코드를 작성해보세요. 값의 합이 5가 되는 경우는 (1, 4), (4, 1), (2, 3), (3, 2)입니다.
*/
        while (true) {
