...
public class interfaceQuiz {
    /*1. 인터페이스에 대한 설명으로 틀린 것은 무엇입니까? 1번
...
2. 인터페이스의 구성 멤버에 대한 설명으로 틀린 것은 무엇입니까?1번
